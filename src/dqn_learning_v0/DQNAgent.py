...
from src.dqn_learning_v0.QNetwork import QNetwork
...
class DQNAgent():
    ...
    def save_model(self, model_id, data_path):
        ...
        torch.save(self.model.state_dict(), data_path + "/dqn_model_" + model_id + "_v0.pt")

    def load_model(self, model_id, data_path):
        self.model.load_state_dict(torch.load(data_path + "/dqn_model_" + model_id + "_v0.pt"))
