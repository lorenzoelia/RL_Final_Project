...
from src.dqn_learning_v1.DQNAgent import DQNAgent
from src.dqn_learning_v1.DQNParameters import DQNParameters
from src.dqn_learning_v1.Epsilon import Epsilon
from src.dqn_learning_v1.QNetwork import train_network, print_scores
        ...
        for lr in lr_options:
            for replay_size in replay_size_options:
                for target_update in target_update_options:
                    ...
                    train_network(env, agent, n_episode, epsilon, dqn_param, train_id, verbose=True, render=False, plot=False)
    env.close()
